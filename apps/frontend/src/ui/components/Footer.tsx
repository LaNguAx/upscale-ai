    ...
    <footer className="section-alt border-t border-border">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-xs">
              AI-powered video restoration and super-resolution. Breathe new
              life into legacy video content using deep learning.
            </p>
          </div>
        ...
        <div className="mt-10 border-t border-border pt-6 text-center text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} Upscale AI. B.Sc. Computer Science
          Final Project.
        </div>
      </div>
    </footer>
